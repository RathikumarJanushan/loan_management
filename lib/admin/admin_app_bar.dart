...
import 'package:loan_managementapp/admin/AllDebtorsPage.dart';
import 'package:loan_managementapp/admin/Debtor.dart';
import 'package:loan_managementapp/admin/admin_home.dart';
import 'package:loan_managementapp/admin/add_staff.dart';
...
class _AdminLayoutState extends State<AdminLayout> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Container(padding: const EdgeInsets.all(16), child: _currentPage),
    );
  }
}
