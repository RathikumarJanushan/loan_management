...
class _AdminHomePageState extends State<AdminHomePage> {
  ...
  Widget _buildKpiSection() {
    ...
    final latestMonthName = DateFormat('MMMM yyyy')
        ...
        child: Column(
          ...
          children: [
            ...
            Text(
              title,
              style: TextStyle(
                  color: const Color.fromARGB(255, 226, 4, 4), fontSize: 14),
            ),
  ...
  Widget _buildChartsView() {
    ...
    return SingleChildScrollView(
      ...
      child: Column(
        children: [
          const Text("Principal & Interest Paid",
          ...
          SizedBox(
              ...
              child: _buildBarChart(
                  sortedMonths, ['interest', 'principal'], chartColors1)),
          const Divider(color: Colors.white54, height: 32),
          const Text("Pending Interest & Loan Balance",
              style: TextStyle(color: Colors.white, fontSize: 16)),
          const SizedBox(height: 8),
          _buildLegend([
          ...
          SizedBox(
              ...
              child: _buildBarChart(sortedMonths,
                  ['pendingInterest', 'loanBalance'], chartColors2)),
        ],
      ),
    );
  }
  ...
  Widget _buildBarChart(
      List<String> sortedMonths, List<String> dataKeys, List<Color> colors) {
  ...
  Future<Uint8List> _generatePdf(ReportType type) async {
    ...
    final Map<String, Map<String, double>> data =
        type == ReportType.monthly ? _monthlySummaries : _yearlySummaries;
                ...
                data: List<List<String>>.generate(
                  ...
                  (index) {
                    ...
                    if (type == ReportType.monthly) {
                      displayKey = DateFormat.yMMMM()
                          .format(DateFormat('yyyy-MM').parse(key));
                    }
                    return [
                      displayKey,
